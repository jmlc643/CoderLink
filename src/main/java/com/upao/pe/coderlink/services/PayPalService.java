...
import com.upao.pe.coderlink.dtos.paypal.*;
...
public class PayPalService {
    ...
    public OrderResponse createOrder(Long paymentId, String returnUrl, String cancelUrl){
        ...
        amount.setValue(String.valueOf(payment.getTotal()));

        PurchaseUnit purchaseUnit = new PurchaseUnit();
        purchaseUnit.setReferenceId(payment.getIdPayment().toString());
